"""
Script to evaluate predictions on the transformed dataset (HotpotQA).
"""
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Script to evaluate predictions"
                                     " on the transformed dataset (HotpotQA).")
    ...
    answer_metric = TransformedAnswerMetric()
    para_support_metric = TransformedSupportingFactsMetric()
    sent_support_metric = TransformedSupportingFactsMetric()
